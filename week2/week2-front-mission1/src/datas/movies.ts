...
export const movies: Movie[] = [
  {
    ...
    genres: ["SF", "액션", "모험"],
    runtime: "2시간 25분",
    tagline: "스파이더맨의 새로운 날이 시작된다",
    overview: "모두의 기억에서 사라진 피터 파커가 새로운 삶과 자신의 정체를 위협하는 적을 마주합니다.",
    isBookmarked: false,
  },
  {
    id: 2,
    ...
    overview: "긴 전쟁을 마친 영웅이 수많은 시련을 지나 고향으로 돌아가는 여정을 그립니다.",
    isBookmarked: true,
  },
  {
    id: 3,
    ...
    genres: ["액션", "모험", "SF"],
    runtime: "2시간 28분",
    tagline: "모든 세계가 하나로 이어진다",
    overview: "정체가 공개된 피터 파커가 도움을 청하는 과정에서 여러 세계의 문이 열립니다.",
    isBookmarked: false,
  },
  {
    id: 4,
    ...
    overview: "외딴 저택에 모인 사람들이 감춰진 사건의 흔적을 발견합니다.",
    isBookmarked: false,
  },
  {
    id: 5,
    ...
    genres: ["애니메이션", "코미디", "모험"],
    runtime: "1시간 35분",
    tagline: "작은 영웅들의 커다란 소동",
    overview: "미니언들이 보스를 찾아간 곳에서 몬스터 친구를 만나 새로운 모험을 시작합니다.",
    isBookmarked: false,
  },
  {
    id: 6,
    ...
    overview: "고립된 연구 기지의 구성원들이 정체를 알 수 없는 신호와 마주합니다.",
    isBookmarked: false,
  },
  {
    id: 7,
    ...
    overview: "우디와 친구들이 새로운 주인을 만나며 장난감의 의미를 다시 찾아갑니다.",
    isBookmarked: true,
  },
  {
    id: 8,
    ...
    runtime: "2시간 10분",
    tagline: "전설의 마지막 화살",
    overview: "오랜 전투를 마친 로빈 후드가 자신의 마지막 선택과 마주합니다.",
    isBookmarked: false,
  },
  {
    id: 9,
    ...
    genres: ["스릴러", "드라마"],
    runtime: "1시간 50분",
    tagline: "완벽한 믿음은 집착으로 변한다",
    overview: "한 사람을 향한 믿음이 점차 위험한 집착으로 바뀌기 시작합니다.",
    isBookmarked: false,
  },
  {
    id: 10,
    ...
    overview: "버려진 오두막을 찾은 사람들이 오래 잠들어 있던 악을 깨웁니다.",
    isBookmarked: false,
  },
];
